...
def main() -> None:
    ...
    for case in cases:
        ...
        elif case.severity.lower() == "high":
            severity_color = Fore.RED + Style.BRIGHT
        elif case.severity.lower() == "medium":
            severity_color = Fore.YELLOW + Style.BRIGHT
        elif case.severity.lower() == "low":
            severity_color = Fore.CYAN + Style.BRIGHT

        status_color = Fore.WHITE

        if case.status.lower() == "open":
            status_color = Fore.GREEN + Style.BRIGHT
        elif case.status.lower() == "closed":
            status_color = Fore.WHITE + Style.DIM
